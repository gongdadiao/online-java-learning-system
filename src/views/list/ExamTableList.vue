<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="plus" @click="$refs.createQuestionModal.create()">添加题目</a-button>
    ...
    <question-create-modal ref="createQuestionModal"  @ok="handleOk" />
...
import QuestionCreateModal from './modules/QuestionCreateModal'
